    ...
    <section id='internships'>
      <div className="container lg:pt-11 ">
        <div className="text-center ">
          <div data-aos='zoom-in' data-aos-duration='1000' className="font-[800]  text-[1.9rem] md:text-[2.5rem] text-bg-secondary-dark dark:text-bg-light hover:text-light-for-light dark:hover:text-light-for-light">Internships</div>
        </div>
        <div className="flex flex-col justify-center sm:py-12">
          <div className="w-full py-3 px-2 sm:max-w-xl sm:mx-auto sm:px-0">
            <div className="relative text-bg-secondary-dark dark:text-bg-light antialiasedbtext-sm text-semibold">
              ...
              <LeftCard title='Flutter Developer' sub='ThanjiLabs(OPC) Pvt ld , Chennai| July 11 2024 - August 11 2024' ri='ri-macbook-line'/>
              <RightCard title='React Developer Intern' sub='CICT-Chennai | Dec 12 2024 - Present' ri='ri-database-2-fill'/>

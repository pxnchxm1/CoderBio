      ...
      <div className="container lg:pt-5 ">
        <div className="flex items-center justify-between flex-wrap">
          <div className="mb-7 sm:mb-0 ">
            <h3 className="font-[800] text-[2.5rem] text-bg-secondary-dark dark:text-bg-light hover:text-light-for-light dark:hover:text-light-for-light">Project Gallery</h3>
          </div>
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap flex-col mt-20 h-[500]">
          {filteredProjects?.map((projects,index) =>{return(
            <div key={index} data-aos='zoom-in' data-aos-duration='2000' className='flex  md:flex-col sm:flex-col lg:flex-row bg-slate-500 bg-opacity-10  backdrop-filter backdrop-blur-lg p-[1.5rem] hover:opacity-60'>
              <div className="group max-w-full  rounded-[8px] sm:w-[48.5%] md:w-[31.8%] lg:w-[52.2%] relative z-[1] ">
                <h2 className='font-[800] pl-[1rem] font-space text-[1.5rem] text-bg-secondary-dark dark:text-light-for-dark hover:text-light-for-light dark:hover:text-light-for-light'>{projects.title}</h2>
                <h5 className="p-[1rem] text-justify sm:text-[10px] md:text-[12px] lg:text-[12px] font-space text-bg-secondary-dark font-[400] dark:text-light-for-light">{projects.description}</h5>
                <h3 className='pl-[1rem] pr-[1rem] text-justify sm:text-[10px] md:text-[12px] lg:text-[12px] font-space text-bg-secondary-dark dark:text-light-for-dark font-[700]'>TechStacks used  </h3>
                  <ul className='flex flex-row pl-[1rem] pr-[1rem] pt-[0.3rem]'>
                ...
                <div className="relative group cursor-pointer  overflow-hidden max-w-full   sm:w-[48.5%] md:w-[31.8%] lg:w-[52.2%]   bg-card-bg bg-opacity-50  backdrop-filter backdrop-blur-lg p-[1.5rem]">            
